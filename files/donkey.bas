...
1090 COLOR 14,0:LOCATE 23,7,0:PRINT "Press Enter to continue"
1100 IF INKEY$<>"" THEN GOTO 1100
1110 CMD$ = INKEY$
1120 IF CMD$ = "" THEN GOTO 1110
1130 IF CMD$ = CHR$(48) THEN GOTO 1298
1140 IF CMD$ = CHR$(13) THEN GOTO 1160
1150 GOTO 1110
1160 DEF SEG=0
...
1220 PRINT "PRESS THE ENTER BAR TO CONTINUE."
1230 DEF SEG
1240 IF INKEY$<>"" THEN GOTO 1240
1250 CMD$ = INKEY$
1260 IF CMD$ = "" THEN GOTO 1250
1270 IF CMD$ = CHR$(48) THEN GOTO 1298
1280 IF CMD$ = CHR$(13) THEN GOTO 1298
1290 GOTO 1250
1291 KEY OFF
...
1631 LOCATE 19,25:PRINT"Press Enter   ";
1632 LOCATE 20,25:PRINT"to switch lanes";
1633 LOCATE 21,25:PRINT"lanes        ";
1635 LOCATE 23,25:PRINT"Press 0    ";
...
1720 SOUND 20000,1
1730 A$=INKEY$:IF A$=CHR$(48) THEN 1298 ELSE POKE 106,0:IF LEN(A$)>0 THEN LINE (CX,CY)-(CX+28,CY+44),0,BF:CX=252-CX:PUT (CX,CY),CAR%,PRESET:SOUND 200,1
